...
<%
    ...
    DetallesPedidosc detallepedidop = DetallesPedidoscControlador.buscarIdFal(id_detallepedidop);
    ...
    obj.put("cantidad_detallepedidop", detallepedidop.getCantidad_detallepedidop());
     obj.put("cantidad_faltantes", detallepedidop.getCantidad_faltante());
    obj.put("descripcion_producto", detallepedidop.getProducto().getDescripcion_producto());
    out.print(obj);
    out.flush();
%>