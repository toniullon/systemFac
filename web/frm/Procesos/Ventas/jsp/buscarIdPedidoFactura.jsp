...
<%
    ...
    PedidosClientes pedidos = PedidosClientesControlador.buscarIdFacturado(id_pedidocliente);
    if (pedidos != null) {
        tipo = "success";
    ...
    String contenido_detallep = DetallesPedidosControlador.buscarIdPedidoFactura(id_pedidocliente);
